...
try 3 "fun main(){ab=3;return ab;}"
try 4 "fun main(){ab=3;return ab+1;}"
try 12 "fun main(){ab=3;return ab*4;}"
try 15 "fun main(){ab=3;cd=5;return ab*cd;}"
try 2 "fun main(){ab=3;cd=5;return cd-ab;}"

try 4 "fun main(){return 4;}"
try 1 "fun main(){return 1; return 2;3;4;}"
try 1 "fun main(){3;4;return 1;return 2;}"
try 2 "fun main(){ab=3;cd=5;return cd-ab; return 6; return 7;}"

try 3 "fun main(){ab=3;cd=5;if(ab==cd)return 2;return 3;}"
try 2 "fun main(){ab=3;cd=5;if(ab!=cd)return 2;return 3;}"
try 2 "fun main(){ab=3;cd=5;if(ab<cd)return 2;return 3;}"
try 3 "fun main(){ab=3;cd=5;if(ab>cd)return 2;return 3;}"
try 3 "fun main(){ab=3;cd=5;if(ab>=cd)return 2;return 3;}"
try 2 "fun main(){ab=6;cd=5;if(ab>=cd)return 2;return 3;}"
try 2 "fun main(){ab=5;cd=5;if(ab>=cd)return 2;return 3;}"
try 2 "fun main(){ab=4;cd=5;if(ab<=cd)return 2;return 3;}"
try 3 "fun main(){ab=6;cd=5;if(ab<=cd)return 2;return 3;}"
try 2 "fun main(){ab=5;cd=5;if(ab<=cd)return 2;return 3;}"

try 3 "fun main(){{return 3; return 4}return 5;}"
try 2 "fun main(){ab=5;cd=5;if(ab==cd){return 2;return 3;}return 5;}"

try 3 "fun get3(){return 3;} fun main(){return get3();}"
try 3 "fun get3(){return 3; return 4;} fun main(){return get3();}"
try 3 "fun get3(){ab=6;cd=5;if(ab<=cd)return 2;return 3;} fun main(){return get3();}"
try 3 "fun get3(){ab=2;cd=5;return cd-ab; return 6; return 7;} fun main(){return get3();}"

try 3 "fun id(a){return a;} fun main(){return id(3);}"
try 7 "fun add(a,b){return a+b;} fun main(){return add(3, 4);}"
try 12 "fun add5(a,b){c=5; return a+b+c;} fun main(){return add5(3, 4);}"
