...
try 5  "fun get4(){return 4;} fun get5(){return get4() + 1;} get5();"
try 7  "fun get3(){return 3;} fun getPlus3(n){return get3() + n;} getPlus3(4);"
try 7  "fun id(n){return n;} fun add(a,b){return id(a) + id(b);} add(3,4);"
try 7  "fun id(a){return a;} fun add(a,b){return id(a) + id(b);} add(3,4);"
try 1 "fun sum(n){if(n == 1){return 1;} return n + sum(n-1);} sum(1);"
try 3 "fun sum(n){if(n == 1){return 1;} return n + sum(n-1);} sum(2);"
try 6 "fun sum(n){if(n == 1){return 1;} return n + sum(n-1);} sum(3);"
try 10 "fun sum(n){if(n == 1){return 1;} return n + sum(n-1);} sum(4);"
try 15 "fun sum(n){if(n == 1){return 1;} return n + sum(n-1);} sum(5);"
try 120 "fun fac(n){if(n == 1){return 1;} return n*fac(n-1);} fac(5);"
try 1 "fun fib(n){if(n == 1){return 1;}if(n == 2){return 1;} return fib(n-1) + fib(n-2);} fib(1);"
try 1 "fun fib(n){if(n == 1){return 1;}if(n == 2){return 1;} return fib(n-1) + fib(n-2);} fib(2);"
try 2 "fun fib(n){if(n == 1){return 1;}if(n == 2){return 1;} return fib(n-1) + fib(n-2);} fib(3);"
try 3 "fun fib(n){if(n == 1){return 1;}if(n == 2){return 1;} return fib(n-1) + fib(n-2);} fib(4);"
